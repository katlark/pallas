...
const base = [
  ...
  // Border
  "border border-stone-950/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-stone-950/30 group-data-checked:bg-(--radio-checked-border)",
  ...
  "[--radio-indicator:transparent] group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:[--radio-indicator:var(--color-stone-900)]/10",
  // Indicator color (dark mode)
  "dark:group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] dark:group-data-hover:[--radio-indicator:var(--color-stone-700)]",
  // Focus ring
  "group-data-focus:outline group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-blue-500",
  // Disabled state
  "group-data-disabled:opacity-50",
  "group-data-disabled:border-stone-950/25 group-data-disabled:bg-stone-950/5 group-data-disabled:[--radio-checked-indicator:var(--color-stone-950)]/50 group-data-disabled:before:bg-transparent",
...
const colors = {
  "dark/stone": [
    "[--radio-checked-bg:var(--color-stone-900)] [--radio-checked-border:var(--color-stone-950)]/90 [--radio-checked-indicator:var(--color-white)]",
    "dark:[--radio-checked-bg:var(--color-stone-600)]",
  ],
  "dark/white": [
    "[--radio-checked-bg:var(--color-stone-900)] [--radio-checked-border:var(--color-stone-950)]/90 [--radio-checked-indicator:var(--color-white)]",
    "dark:[--radio-checked-bg:var(--color-white)] dark:[--radio-checked-border:var(--color-stone-950)]/15 dark:[--radio-checked-indicator:var(--color-stone-900)]",
  ],
  white:
    "[--radio-checked-bg:var(--color-white)] [--radio-checked-border:var(--color-stone-950)]/15 [--radio-checked-indicator:var(--color-stone-900)]",
  dark: "[--radio-checked-bg:var(--color-stone-900)] [--radio-checked-border:var(--color-stone-950)]/90 [--radio-checked-indicator:var(--color-white)]",
  stone:
    "[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-stone-600)] [--radio-checked-border:var(--color-stone-700)]/90",
